...
const Characters = (
	...
	useEffect(() => {
		if (playGroundRef.current) {
			...
			const observer = new ResizeObserver(() => doAction('CONTROL_CHARACTERS_POSITION', {
				width: playGroundRef.current?.clientWidth,
				height: playGroundRef.current?.clientHeight
			}));
